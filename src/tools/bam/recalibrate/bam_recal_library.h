...
struct recal_info {
    ...
    double* qual_cycle_empirical_Q; 	//Empirical quality per quality-cycle pair
    ...
    double* qual_dinuc_empirical_Q; 	//Empirical quality per quality-dinuc pair
};
